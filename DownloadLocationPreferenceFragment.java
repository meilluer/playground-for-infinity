...
public class DownloadLocationPreferenceFragment extends SearchablePreferenceFragment {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        if (gifDownloadLocationPreference != null) {
            ...
            gifDownloadLocationPreference.setOnPreferenceClickListener(preference -> {
                System.err.println("gifDownloadLocationPreference clicked!");
                Intent intent = new Intent(ACTION_OPEN_DOCUMENT_TREE);
    ...
    @Override
    public Integer getPreferenceScreenResId() {
        return R.xml.download_location_preferences;
    }
}
